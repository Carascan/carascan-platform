...
function HeroCard({ iconSrc, iconAlt, title, description }: HeroCardProps) {
  return (
    <div
      style={{
        borderRadius: 18,
      ...
      >
        <img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
                        objectPosition: isMobile ? "68% center" : "50% 58%",
            display: "block",
          }}
        />
